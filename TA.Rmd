...
We selected brand, flavor, package, promo, ad and producer to examine indivudually.
...
hl_cocoa_gm <- highlight_cocoa_gm %>%
  ...
  scale_y_continuous(labels = dollar) +
  ggtitle("General Mills Revenue Changing with Flavor and Advertising Volume", sub = "(Cocoa flavor has a different distribution)")
